...
public class TestApplet extends Applet{
	...
	byte[] resp6 = {(byte)0x7a, (byte)0x29};
	...
	public void process(APDU apdu) {
		...
		if ( (short)(255 - memPointer) < (short)(buf[ISO7816.OFFSET_LC] + 5) ) {
		...
		short recievedLen = (short)((buf[ISO7816.OFFSET_LC] + 5) & (short)0xff);
		switch (buf[ISO7816.OFFSET_INS]) {
			case (byte)0xa4: // first APDU
				...
				memPointer += buf[ISO7816.OFFSET_LC] + 5;
			...
			case (byte)0xcb: // fifth APDU
				apdu.setIncomingAndReceive(); // read APDU data bytes
				Util.arrayCopy(buf, (short)0, destMemory, (byte) memPointer, recievedLen);
				memPointer += buf[ISO7816.OFFSET_LC] + 5;
